...
// For pnpm compatibility, try multiple paths to find webpack
let webpack
try {
  webpack = require('@vue/cli-service/node_modules/webpack')
} catch (e) {
  // Fallback for pnpm: webpack might be hoisted to root node_modules
...
const vueConfig = {
  configureWebpack: {
    ...
    plugins: [
      ...
      // Disabled for webpack 5 compatibility
