...
const locale = {
  ...
  'app.setting.pagestyle.skyblue': '天空蓝极简',
  'app.setting.pagestyle.xp': 'Windows XP 经典',
  ...
  'user.login.infos': 'QuantumQuant 是一个 AI 多智能体股票分析辅助工具，不具备证券投资咨询资质。平台中的所有分析结果、评分、参考意见均由 AI 基于历史数据自动生成，仅供学习、研究与技术交流使用,不构成任何投资建议或决策依据。股票投资存在市场风险、流动性风险、政策风险等多种风险，可能导致本金损失。用户应基于自身风险承受能力独立决策，使用本工具产生的任何投资行为及其后果由用户自行承担。市场有风险，投资需谨慎。',
  ...
  'user.login.legal.content': 'QuantumQuant 是一个 AI 多智能体股票分析辅助工具，不具备证券投资咨询资质。平台中的所有分析结果、评分、参考意见均由 AI 基于历史数据自动生成，仅供学习、研究与技术交流使用，不构成任何投资建议或决策依据。股票投资存在市场风险、流动性风险、政策风险等多种风险，可能导致本金损失。用户应基于自身风险承受能力独立决策，使用本工具产生的任何投资行为及其后果由用户自行承担。市场有风险，投资需谨慎。',
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR 和 MT5 属于外挂类实盘接口，需要本地部署运行 QuantumQuant，不支持云端 SaaS 模式。请确保您已在本地安装并配置相关交易软件（TWS/IB Gateway 或 MT5 终端）。',
  ...
  'settings.option.LLM_PROVIDER.openai-compatible': 'OpenAI Compatible（Nvidia / 私有部署）',
  'settings.option.LLM_PROVIDER.ollama': 'Ollama（本地模型）',
  ...
  'settings.field.OLLAMA_BASE_URL': 'Ollama 服务地址',
  'settings.field.OLLAMA_MODEL': 'Ollama 模型名称',
  ...
  'settings.desc.OLLAMA_BASE_URL': '本地 Ollama 服务 URL，默认 http://localhost:11434/v1',
  'settings.desc.OLLAMA_MODEL': 'Ollama 中已拉取的模型名，如 qwen2.5:7b、llama3.2 等',
  ...
  'userManage.assignRoles': '分配角色',

  // Role Management
  'roleManage.title': '角色管理',
  'roleManage.description': '管理系统角色和权限分配',
  'roleManage.descLabel': '描述',
  'roleManage.createRole': '新增角色',
  'roleManage.editTitle': '编辑角色',
  'roleManage.createTitle': '新增角色',
  'roleManage.name': '角色名称',
  'roleManage.namePlaceholder': '请输入角色名称',
  'roleManage.code': '角色编码',
  'roleManage.codePlaceholder': '如 admin / trader',
  'roleManage.descPlaceholder': '角色描述说明',
  'roleManage.status': '状态',
  'roleManage.fetchFailed': '加载角色列表失败',
  'roleManage.createSuccess': '角色创建成功',
  'roleManage.updateSuccess': '角色更新成功',
  'roleManage.deleteSuccess': '角色删除成功',
  'roleManage.confirmDelete': '确定删除此角色？',
  'roleManage.assignPermission': '分配权限',
  'roleManage.permissionFetchFailed': '加载权限数据失败',
  'roleManage.permissionSaved': '权限分配成功',
  'roleManage.requiredFields': '请填写角色名称和编码',
  'roleManage.searchPlaceholder': '请填写查询内容',

  // Permission Management
  'permManage.title': '权限管理',
  'permManage.description': '管理系统菜单和权限节点',
  'permManage.addDir': '新增目录',
  'permManage.addMenu': '新增菜单',
  'permManage.addButton': '新增按钮',
  'permManage.type': '类型',
  'permManage.typeDir': '目录',
  'permManage.typeMenu': '菜单',
  'permManage.typeButton': '按钮',
  'permManage.name': '权限名称',
  'permManage.namePlaceholder': '如 用户管理',
  'permManage.code': '权限编码',
  'permManage.codePlaceholder': '如 system:user:view',
  'permManage.parent': '父级权限',
  'permManage.parentPlaceholder': '选择父级（目录下才能为菜单/按钮）',
  'permManage.path': '路由路径',
  'permManage.component': '组件路径',
  'permManage.icon': '图标',
  'permManage.sortOrder': '排序',
  'permManage.visible': '可见',
  'permManage.status': '状态',
  'permManage.fetchFailed': '加载权限树失败',
  'permManage.editTitle': '编辑权限',
  'permManage.createTitle': '新增权限',
  'permManage.createSuccess': '权限创建成功',
  'permManage.updateSuccess': '权限更新成功',
  'permManage.deleteSuccess': '权限删除成功',
  'permManage.confirmDelete': '确定删除此权限？子节点将一并删除',
  'permManage.requiredFields': '请填写权限名称和编码',
  ...
  'profile.exchange.openAccountPromo': 'QuantumQuant 专属开户，享最高 20% 返佣',
  ...
  'profile.exchange.localDeploymentHint': '此券商需要在本地部署 QuantumQuant 才能使用。',
  ...
  'trading-assistant.editor.docsIntroDesc': '这里展示的是 QuantumQuant 脚本策略可用的常用 API 与生命周期说明，方便你边写边查。',
