        ...
        <div class="code-panel" :class="{ collapsed: !codePanelExpanded }">
          ...
          <div v-show="codePanelExpanded" class="code-panel-body">
            <div class="ide-guide-bar">
              ...
              <a href="https://github.com/brokermr810/QuantumQuant/blob/main/docs/STRATEGY_DEV_GUIDE.md" target="_blank" rel="noopener noreferrer" class="ide-guide-link" @click.stop>
