    ...
    >
      ...
      <template #menuHeaderRender>
        <div class="sidebar-logo-wrapper" :class="{ 'sidebar-logo-wrapper--collapsed': collapsed }">
          <img v-if="collapsed" :src="slogoImg" class="sidebar-logo sidebar-logo--collapsed" alt="QuantumQuant" />
          <img v-else :src="currentLogo" class="sidebar-logo" alt="QuantumQuant" />
        </div>
      </template>
      ...
      <div v-if="!collapsed" class="menu-footer-content">
        ...
        <div class="footer-section">
          <div class="section-links">
            <a @click="showLegalModal = true">Private Quantitative Usage</a>
          </div>
        </div>
      </div>
    </div>
...
import slogoImg from '@/assets/slogo.svg'
...
export default {
  ...
  data () {
    return {
      ...
      menuFooterConfig: {
        ...
        copyright: '© 2025-2026 QuantumQuant. All rights reserved.'
      },
  ...
  computed: {
    ...
    currentLogo () {
      // Logo is the same for both themes now
      return logo
    }
  },
  created () {
