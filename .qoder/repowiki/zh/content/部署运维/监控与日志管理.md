...
- [backend/app/utils/strategy_runtime_logs.py](file://backend/app/utils/strategy_runtime_logs.py)
</cite>

## 更新摘要
**所做更改**
- 更新了日志系统章节，反映新增的增强日志记录系统
- 新增了日志格式优化和调试支持改进的内容
- 更新了日志配置和使用方式的相关说明
- 增强了生产部署优化相关的日志管理指导
...
**章节来源**
- [backend/app/utils/logger.py:9-71](file://backend/app/utils/logger.py#L9-L71)
- [backend/app/config/settings.py:43-91](file://backend/app/config/settings.py#L43-L91)
...
participant App as "Flask应用工厂(run.py)"
...
- [backend/app/utils/logger.py:9-48](file://backend/app/utils/logger.py#L9-L48)
...
Filter --> DebugFormat["调试模式格式化"]
DebugFormat --> Ready(["日志系统就绪"])
subgraph "配置来源"
Env["环境变量"]
...
- [backend/app/utils/logger.py:9-71](file://backend/app/utils/logger.py#L9-L71)
- [backend/app/config/settings.py:43-91](file://backend/app/config/settings.py#L43-L91)
- [backend/app/utils/strategy_runtime_logs.py:11-23](file://backend/app/utils/strategy_runtime_logs.py#L11-L23)
...
**图表来源**
- [backend/app/routes/health.py:10-109](file://backend/app/routes/health.py#L10-L109)
...
**章节来源**
- [backend/Dockerfile:47-55](file://backend/Dockerfile#L47-L55)
- [backend/start.sh:18-22](file://backend/start.sh#L18-L22)
...
**章节来源**
- [backend/docker-entrypoint.sh:25-42](file://backend/docker-entrypoint.sh#L25-L42)
- [backend/app/utils/logger.py:35-48](file://backend/app/utils/logger.py#L35-L48)
