...
const locale = {
  ...
  'app.setting.pagestyle.skyblue': 'Sky Blue Minimalist',
  'app.setting.pagestyle.xp': 'Windows XP Classic',
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR and MT5 are external trading interfaces that require local deployment of QuantumQuant. Cloud SaaS mode is not supported. Please ensure you have installed and configured the trading software (TWS/IB Gateway or MT5 terminal) on your local machine.',
  ...
  'settings.option.LLM_PROVIDER.openai-compatible': 'OpenAI Compatible (Nvidia / Private)',
  ...
  'userManage.assignRoles': 'Assign Roles',
  ...
  'trading-assistant.editor.docsIntroDesc': 'These are the commonly used QuantumQuant script strategy APIs and lifecycle hooks, so you can code and look up usage side by side.',
  ...
  'quickTrade.tpslRecordOnlyHint': 'Note: TP/SL prices are saved in QuantumQuant trade records only. They are not sent to the exchange as native TP/SL or trigger orders. Set exchange-side TP/SL on the exchange if you need that.',
  ...
  'profile.exchange.openAccountPromo': 'QuantumQuant exclusive signup — up to 20% commission rebate',
  ...
  'profile.exchange.localDeploymentHint': 'This broker requires local deployment of QuantumQuant to use.',
  ...
  // LLM Settings
  'menu.llmSettings': 'LLM Settings',
  'llm.pageTitle': 'LLM Settings',
  'llm.pageSubtitle': 'Manage LLM providers, API keys, and model routing strategies',
  'llm.provider': 'Provider',
  'llm.providerName': 'Provider Name',
  'llm.baseUrl': 'Base URL',
  'llm.apiKey': 'API Key',
  'llm.model': 'Model',
  'llm.modelName': 'Model Name',
  'llm.strategy': 'LB Strategy',
  'llm.weight': 'Weight',
  'llm.status': 'Status',
  'llm.latency': 'Latency',
  'llm.calls': 'Calls',
  'llm.successRate': 'Success Rate',
  'llm.lastUsed': 'Last Used',
  'llm.actions': 'Actions',
  'llm.addProvider': 'Add Provider',
  'llm.addKey': 'Add Key',
  'llm.addModel': 'Add Model',
  'llm.strategy.round_robin': 'Round Robin',
  'llm.strategy.weighted_round_robin': 'Weighted RR',
  'llm.strategy.random': 'Random',
  'llm.strategy.least_connections': 'Least Connections',
  'llm.strategy.consistent_hash': 'Consistent Hash',
  'llm.status.active': 'Active',
  'llm.status.disabled': 'Disabled',
  'llm.status.broken': 'Circuit Broken',

  // Role Management
  'roleManage.title': 'Role Management',
  'roleManage.description': 'Manage system roles and permissions',
  'roleManage.createRole': 'Create Role',
  'roleManage.editTitle': 'Edit Role',
  'roleManage.createTitle': 'Create Role',
  'roleManage.name': 'Role Name',
  'roleManage.namePlaceholder': 'Enter role name',
  'roleManage.code': 'Role Code',
  'roleManage.codePlaceholder': 'e.g., admin / trader',
  'roleManage.descLabel': 'Description',
  'roleManage.descPlaceholder': 'Role description',
  'roleManage.status': 'Status',
  'roleManage.fetchFailed': 'Failed to load role list',
  'roleManage.createSuccess': 'Role created successfully',
  'roleManage.updateSuccess': 'Role updated successfully',
  'roleManage.deleteSuccess': 'Role deleted successfully',
  'roleManage.confirmDelete': 'Are you sure to delete this role?',
  'roleManage.assignPermission': 'Assign Permissions',
  'roleManage.permissionFetchFailed': 'Failed to load permissions',
  'roleManage.permissionSaved': 'Permissions assigned successfully',
  'roleManage.requiredFields': 'Please enter role name and code',
  'roleManage.searchPlaceholder': 'Please enter search place holder',

  // Permission Management
  'permManage.title': 'Permission Management',
  'permManage.description': 'Manage system menus and permission nodes',
  'permManage.addDir': 'Add Directory',
  'permManage.addMenu': 'Add Menu',
  'permManage.addButton': 'Add Button',
  'permManage.type': 'Type',
  'permManage.typeDir': 'Directory',
  'permManage.typeMenu': 'Menu',
  'permManage.typeButton': 'Button',
  'permManage.name': 'Permission Name',
  'permManage.namePlaceholder': 'e.g., User Management',
  'permManage.code': 'Permission Code',
  'permManage.codePlaceholder': 'e.g., system:user:view',
  'permManage.parent': 'Parent Permission',
  'permManage.parentPlaceholder': 'Select parent (only menu/button under directory)',
  'permManage.path': 'Route Path',
  'permManage.component': 'Component Path',
  'permManage.icon': 'Icon',
  'permManage.sortOrder': 'Sort Order',
  'permManage.visible': 'Visible',
  'permManage.status': 'Status',
  'permManage.fetchFailed': 'Failed to load permission tree',
  'permManage.editTitle': 'Edit Permission',
  'permManage.createTitle': 'Create Permission',
  'permManage.createSuccess': 'Permission created successfully',
  'permManage.updateSuccess': 'Permission updated successfully',
  'permManage.deleteSuccess': 'Permission deleted successfully',
  'permManage.confirmDelete': 'Are you sure to delete this permission? Child nodes will also be deleted',
  'permManage.requiredFields': 'Please enter permission name and code',
