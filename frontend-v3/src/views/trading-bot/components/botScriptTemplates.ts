...
export const BOT_SCRIPT_TEMPLATES: Record<string, (params: Record<string, any>, context?: { timeframe?: string }) => string> = {
...
export function generateBotScript(botType: string, params: Record<string, any>, context?: { timeframe?: string }): string {
