...
import {
  ...
  BarChartOutlined, FallOutlined, StockOutlined, FundOutlined
...
const botTypes = computed(() => [
  {
    key: 'grid',
    name: t('trading-bot.type.grid'),
    desc: t('trading-bot.type.gridDesc'),
    icon: BarChartOutlined,
    gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
    riskLabel: t('trading-bot.risk.medium'),
    riskClass: 'medium',
    scene: t('trading-bot.scene.range')
  },
  {
    key: 'martingale',
    name: t('trading-bot.type.martingale'),
    desc: t('trading-bot.type.martingaleDesc'),
    icon: FallOutlined,
    gradient: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)',
    riskLabel: t('trading-bot.risk.high'),
    riskClass: 'high',
    scene: t('trading-bot.scene.dip')
  },
  {
    key: 'trend',
    name: t('trading-bot.type.trend'),
    desc: t('trading-bot.type.trendDesc'),
    icon: StockOutlined,
    gradient: 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)',
    riskLabel: t('trading-bot.risk.medium'),
    riskClass: 'medium',
    scene: t('trading-bot.scene.trending')
  },
  {
    key: 'dca',
    name: t('trading-bot.type.dca'),
    desc: t('trading-bot.type.dcaDesc'),
    icon: FundOutlined,
    gradient: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)',
    riskLabel: t('trading-bot.risk.low'),
    riskClass: 'low',
    scene: t('trading-bot.scene.longTerm')
  }
])
</script>
